...
(function (n, m, C, v, e) {
	...
	function Ta() {
		...
		if (!d.autoScrolling || d.scrollBar) {
			if (!w(a, "active")) {
				...
				k = q(a) + 1;
				if (g = e(".fp-slide.active", a)) var l = g.getAttribute("data-anchor"),
					m = q(g);
		...
		if (!ja) {
			...
			if (b.length) {
				var c = "undefined" === typeof F,
					d = "undefined" === typeof F && "undefined" === typeof a && !G;
	...
	function Oa(a) {
		...
		else if (oa || ra) history.replaceState(C,
			C, "#" + a);
		else {
	...
	var d, G = !1,
		oa = navigator.userAgent.match(/(iPhone|iPod|iPad|Android|playbook|silk|BlackBerry|BB10|Windows Phone|Tizen|Bada|webOS|IEMobile|Opera Mini)/),
		ra = "ontouchstart" in n || 0 < navigator.msMaxTouchPoints ||
	...
	return {
		initialize: function (a, b) {
			...
			for (g = 0; g < l.length; g++)
				if (f = g, c = l[g], k = p(".fp-slide", c), h = k.length, f || null !== e(".fp-section.active") || t(c, "active"), "undefined" !== typeof d.anchors[f] && (c.setAttribute("data-anchor", d.anchors[f]), w(c, "active") && Z(d.anchors[f],
						f)), 0 < h) {
					var y = 100 * h,
						f = 100 / h;
